...
fun PatternLinesBased_MobileMiniApp(
	...
	MobileMiniApp(
		...
		testFunctionality = object : PatternLinesBasedFunctionality {
			override fun printPattern1(lines: Int) = PatternCorrectImplHelper.getForLinesBased(patternCode)(lines)
		},
		testClass = testClass,
